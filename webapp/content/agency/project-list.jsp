    ...
    <div class="td-layout">
        <aside class="td-sidebar">
            ...
            <nav class="td-menu">
                ...
                <a href="${ctx}/agency/project-list.jsp" class="td-menu-item active">
        ...
        <div class="td-main">
            <header class="td-header">
                <div class="td-header-search">
                    ...
                    <input type="text" placeholder="搜索代理项目 (Ctrl + /)">
                </div>
            ...
            <main class="td-content">
                ...
                <div style="margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <h2 style="font-size: 20px; font-weight: 500; margin-bottom: 8px;">代理项目管理</h2>
                        <p style="color: var(--td-text-color-secondary); font-size: 14px; margin: 0;">招标代理业务全流程管理</p>
                    </div>
                    <div class="btn-group">
                        <button class="btn btn-default active">全量标段</button>
                        <button class="btn btn-default">我的标段</button>
                        <button class="btn btn-default">待审核</button>
                    </div>
                </div>
                ...
                <div class="td-card" style="padding: 20px;">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label style="font-size: 12px; color: var(--td-text-color-secondary); margin-bottom: 4px; display: block;">委托单位</label>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-family:monospace; font-weight:600;">${item.fee}</td>
                                <td>
